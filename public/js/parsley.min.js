...
(function (global, factory) {
  ...
  ParsleyFactory.prototype = {
    init: function init(options) {
      ...
      if (this.$element.is('div') || ParsleyUtils__default.checkAttr(this.$element, this.options.namespace, 'validate') && !this.$element.is(this.options.inputs)) return this.bind('parsleyForm');
